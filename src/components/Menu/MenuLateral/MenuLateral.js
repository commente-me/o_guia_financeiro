...
import SetaImagem from '../../../imagens/Home/HomeEducacional/voltar.svg';
...
const Menu = () => {
    ...
    return (
        <div id="navegacao">
            ...
            <nav id="nav">
                <ul className="ulNav2">
                    ...
                    <li className="liEspacoTrans alinharTopo li" >
                        <Link to="/" >
                            <img style={{width: '18px!important'}} className="bordaImg direcao1" src={Icon1} alt="" />
                        </Link>
                    </li>
                    <li className="liEspacoTrans li">
                        <Link to="" >
                            <img style={{width: '18px!important'}} className="bordaImg direcao2" src={Icon2} alt="" />
                        </Link>
                    </li>
                    <li className="liEspacoTrans li">
                        <Link to="">
                            <img style={{width: '18px!important'}} className="bordaImg direcao1" src={Icon3} alt="" />
                        </Link>
                    </li>
                    <li className="liEspacoTrans li">
                        <Link to="" >
                            <img style={{width: '18px!important'}} className="bordaImg direcao1" src={Icon4} alt="" />
                        </Link>
                    </li>
                    <li className="liEspacoBranco li">
                        <Link to="">
                            <img style={{width: '18px!important'}} className="bordaImg direcao1" src={Icon5} alt="" />
                        </Link>
                    </li>
                    <li className="liEspacoTrans li">
                        <Link to="" >
                            <img style={{width: '18px!important'}} className="bordaImg direcao1" src={Icon6} alt="" />
                        </Link>
                    </li>
                    <li className="liEspacoBranco li">
                        <Link to="" >
                            <img style={{width: '18px!important'}} className="bordaImg direcao1" src={Icon7} alt="" />
                        </Link>
                    </li>
                    <li className="liEspacoTrans li">
                        <Link to="" >
                            <img style={{width: '18px!important'}} className="bordaImg direcao1" src={Icon8} alt="" />
                        </Link>
                    </li>
                </ul>
            </nav>
                        ...
                        <li className="liEspaco">
                            <Link to="">
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', height: '80px' }}>
                                    <p style={{ borderBottom: '0.1px solid #FFFFFF', width: '130px' }}>&nbsp;</p>
                                    <span >Mentoria</span>
                                </div>
                            </Link>
                        </li>
            ...
            <div className={menu ? "fundoAcimaDaTela fundoAcimaDaTelaAtiva": "fundoAcimaDaTela"} onClick={showNavegacao}>
