        ...
        <div className="footerHomeEducacional">
            ...
            <div className="footer02">
                ...
                <div className="footerColuna02">
                    ...
                    <Link to="" style={{marginRight: '16px'}}><p>Política de privacidade</p></Link>
                    <Link to=""><p>Política de cookies</p></Link>
                    </div>
                    <div className="FooterCol02">
                    <Link to="" style={{marginRight: '16px'}}><p>Termos e condições</p></Link>
                    <Link to=""><p>Aviso sobre risco</p></Link>
                    </div>
                </div>
            </div>
        </div>
